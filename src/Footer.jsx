    ...
    return (
       <footer style={{backgroundColor:"	rgb(245, 245, 245)"}}>
        <div className="container border-top mt-5">
            ...
            <div className="col"> <img src="media/images/stock-logo.png" alt="logo" style={{width:"10%"}} />  <h5>StockStream</h5>
...
Smart Online Dispute Resolution | Grievances Redressal Mechanism </p><br />

Investments in securities market are subject to market risks; read all the related documents carefully before investing.

Attention investors: <br /> <p>Stock brokers can accept securities as margins from clients only by way of pledge in the depository system w.e.f September 01, 2020. 2) Update your e-mail and phone number with your stock broker  <br /> depository participant and receive OTP directly from depository on your e-mail and/or mobile number to create pledge. 3) Check your securities / MF / bonds in the consolidated account statement issued by NSDL/CDSL every month.
...
"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Zerodha and offering such services, please create a ticket here.
            ...
            <div className="container " style={{display:"flex", justifyContent:"space-evenly"}}>
                ...
                <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>NSE</a></div>
                <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>BSE</a></div>
                <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>MCX</a></div>
               <div className="col-1"> <a href="" className="text-muted" style={{textDecoration:"none"}}>Terms & conditions</a></div>
               <div className="col-1"> <a href="" className="text-muted" style={{textDecoration:"none"}}>Policies & procedures</a></div>
               <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>Privacy policy</a></div>
                <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>Disclosure</a></div>
                <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>For investor's attention</a></div>
                <div className="col-1"><a href="" className="text-muted" style={{textDecoration:"none"}}>Investor charter</a></div>
            </div>
